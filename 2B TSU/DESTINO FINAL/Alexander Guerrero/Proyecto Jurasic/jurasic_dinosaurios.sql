...
CREATE TABLE `dinosaurios` (
  `iddinosaurios` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dinosaurios` VALUES (1,'Tiranosaurus Rex',23,35,'Cretasico'),(2,'Triceratops',16,40,'Cretasico'),(3,'Velociraptor',30,20,'Cretasico'),(4,'Spinosaurus',20,45,'Cretacico'),(5,'Diplodocus',16,30,'Jurasico');
