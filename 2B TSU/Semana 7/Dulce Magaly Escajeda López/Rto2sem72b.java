...
public class Rto2sem72b {
    ...
    public static void main(String[] args) {
     ...
     int pokemonA2=0;
        System.out.println("\n============================");
        System.out.println("QUE COMIENCEN LOS POKETRANCAZOS!");
        System.out.println("============================\n");
        ...
        while (pokemonA1 <3 && pokemonA2 <3) {
         ...
         System.out.println("----------------------------");
            ...
            if(vida[1][pokemonA2]<= 0){
             System.out.println("¡" + nombres[1][pokemonA2] + "ha sido poketranqueado (derrotado)!");
             pokemonA2++; 
            ...
            if (vida[0][pokemonA1] <= 0) {
                System.out.println("¡" + nombres[0][pokemonA1] + " ha sido poketranqueado (derrotado)!");
                pokemonA1++;
        ...
        System.out.println("      ERES EL MAESTRO DE LOS POKETRANCAZOS");
        System.out.println("***************************************");
