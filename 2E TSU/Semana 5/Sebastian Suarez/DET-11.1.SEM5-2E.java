...
public class SistemaVentas {
    ...
    public static void main(String[] args) {
        ...
        if (contador > 0){
            System.out.println("Hay" + contador + "ventas mayores o igual al promedio");
        }
        else{
            System.out.println("No hay ventas mayores o igual al promedio");    
        }
        System.out.println("Total vendido: " + total);
        System.out.println("Promedio: " + promedio);
        System.out.println("Venta mayor: " + mayor);
        System.out.println("Cantidad mayores o igual al promedio: " + contador);
