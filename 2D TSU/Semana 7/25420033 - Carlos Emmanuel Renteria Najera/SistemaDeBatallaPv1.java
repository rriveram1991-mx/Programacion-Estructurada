 ...
 * @author Memer
 */
public class SistemaDeBatallaPv1 {
        ...
        while(opc != 4){
            ...
            switch(opc){
                ...
                case 3:
                    ...
                    System.out.println("Nombre " + " Vida " + " Ataque ");
                    MostrarEquipos(J1);
                    System.out.println();
            ...
            int fila = -1;
                    for (int i = 0; i < equipo.length; i++) {
                        ...
                        if (fila != -1) {
                            ...
                            while(!equipo[fila][1].matches("\\d+")) {
                                System.out.println("vuelve a ingresar un numero correcto");
                                equipo[fila][1] = lr.nextLine(); 
                            }
    ...
    public static void MostrarEquipos(String[][] equipo){
            ...
            if (equipo[0][0] == null) {
                        System.out.println("No tienes pokemon registrados");
            }
            ...
            for (int i = 0; i < equipo1.length; i++) {
                ...
                if (equipo1[i][0] != null && equipo1[i][0].equalsIgnoreCase(buscar)) {
                    ...
                    equipo2[i][1] = Integer.toString(nuevaV);
                        ...
                        System.out.println("ese pokemon esta derrotado, elige otro");
                        return false;
                    }             
                }   
            }
    ...
    public static boolean equipoDerrotado(String[][] equipo) {
        for (String[] equipo1 : equipo) {
            if (equipo1[0] != null) {
                int vida = Integer.parseInt(equipo1[1]);
                if (vida > 0) {
                    return false; 
                }
            }
            ...
            switch(accion){
                ...
                case 2:
                    ...
                    MostrarEquipos(equipo2);
                        break;
                case 3:
                        System.out.println("el jugador " + turno +" se ha retirado...");
                        BA = false;
                    break;
                default:
